...
def detail_url(recipe_id):
    """Create and return ia recipe detail URL"""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrive_recipes(self):
        ...
        # many=True because we retrive list of object
    ...
    def test_create_recipe_with_new_tags(self):
        """Test create a new recipe with new tags."""
        payload = {
    ...
    def test_update_recipe_assiggn_tag(self):
    ...
    def test_create_ingedient_on_update(self):
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        # checking if 'Salt' is repleaced by 'Pepper'
    ...
    def test_filter_by_tags(self):
        ...
        recipe2 = create_recipe(user=self.user, title='Pierogi')
